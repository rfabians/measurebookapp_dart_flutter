                                      ...
                                      Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text(funcionesGenericas.redondearDouble(alturaPunto, 3).toString(), style: TextStyle(fontSize: 12, color: Colors.white),textAlign: TextAlign.center),
                                          ))
                                        ],
                                      )
                                    ],
                                      ...
                                      child: GestureDetector(
                                        onTap: ()async{
                                          ...
                                          setState(() {
                                            ...
                                            alturaPunto = funcionesGenericas.redondearDouble(posicionUser.altitude, 3);
                                          });
                                        },
                                                    ...
                                                    child: Column(
                                                      children: <Widget>[
                                                        TextFormField(
                                                          ...
                                                          validator: (String latitudPunto){
                                                            if(latitudPunto.isEmpty){
                                                        ...
                                                        TextFormField(
                                                          ...
                                                          validator: (String longitudPunto){
                                                            if(longitudPunto.isEmpty){
