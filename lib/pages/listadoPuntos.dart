                      ...
                      if(snapshot.data.length<=0) {
                        ...
                        return MediaQuery.removePadding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              SizedBox(height: 10),
                              Image.asset('assets/images/puntos.png',height: 80,),
                              SizedBox(
                                height: 10,
                              ),
                              Text('Listado Puntos de Referencia', style: TextStyle(
                                            ...
                                            child: Row(
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  child: FittedBox(
                                                    fit: BoxFit.cover,
                                                    child: _mostarFoto(listPuntsRef.Foto_Placa),
                                                  ),
                                                ),
                                                Container(
                                                  height: 150,
                                                  ...
                                                  child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: <Widget>[
                                                      Align(alignment: Alignment.center,child: Text('${listPuntsRef.Nombre_Punto}', style: TextStyle(fontFamily: 'Roboto',color: Colors.blueAccent,fontSize: 14.0),),),
                                                      ...
                                                      Align(alignment: Alignment.centerRight,child: Text('${listPuntsRef.Norte}', style: TextStyle(fontFamily: 'Roboto',color: Colors.blueAccent,fontSize: 12.0),),),
                                                      Divider(height: 2,),
                                                      ...
                                                      Align(alignment: Alignment.centerRight,child: Text('${listPuntsRef.Este}', style: TextStyle(fontFamily: 'Roboto',color: Colors.blueAccent,fontSize: 12.0),),),
                                                      Divider(height: 2,),
                                                      ...
                                                      Align(alignment: Alignment.centerRight,child: Text('${listPuntsRef.Altura}', style: TextStyle(fontFamily: 'Roboto',color: Colors.blueAccent,fontSize: 12.0),),),
                                                      Divider(height: 2,),
                                                      ...
                                                      Align(alignment: Alignment.centerRight,child: Text('${listPuntsRef.Tipo_Altura}', style: TextStyle(fontFamily: 'Roboto',color: Colors.blueAccent,fontSize: 12.0),),),
                                                      Divider(height: 2,),
                                                    ],
                                                  ),
                                                ),
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Material(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: (){
                                                            gestorMBDatabase.db.InserDataSQL('DELETE FROM PUNTOS_REFERENCIA WHERE ID_Punto = ${listPuntsRef.ID_Punto}');
