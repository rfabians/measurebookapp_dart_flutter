                         ...
                         FlatButton(
                           onPressed: ()async{
                              GaussCS gaussCS = await gestorMBDatabase.db.getOrigenGaussData(widget.idProyeccion);
                               ...
                               if(cont>0){
                                 if(widget.proyeccionMB == 'Gauss-Krüger'){
                               ...
                               if(sistemadestinoRef == 'Elipsoidales'){
                                  ...
                                  List<String> nombrePunto = List<String>(cont);
                                  List<List<dynamic>> ref2Elispodailes = List<List<dynamic>>(cont+1);
                               ...
                               for (var i = 0; i < cont; i++) {
                                ...
                                String datosCSV = const ListToCsvConverter().convert(ref2Elispodailes);
                              ...
                              }else if(sistemadestinoRef == 'Geocentricas'){
                                  List<CoordenadasElipsoidales> listCoorElip = List<CoordenadasElipsoidales>(cont);
                                  List<CoordenadasGeocentricas> listCoorGeocen = List<CoordenadasGeocentricas>(cont);
                                  List<String> nombrePunto = List<String>(cont);
                                  List<List<dynamic>> ref2Elispodailes = List<List<dynamic>>(cont+1);
                                  List<String> puntos0 = List(4);
                                  puntos0[0] = 'ID Punto';
                               ...
                               for (var i = 0; i < cont; i++) {
                                  nombrePunto[i] = listaRef[i].Nombre_Punto;
                                  listCoorElip[i] = conversionCoordenadasMB.gauss2Elipsoidales(gaussCS, CoordenadasGauss(norte: listaRef[i].Norte, este: listaRef[i].Este, altura: listaRef[i].Altura));
                                  listCoorGeocen[i] = conversionCoordenadasMB.elipsoidales2Geocentricas(listCoorElip[i]);
                                  List<dynamic> puntos = List(4);
                                  puntos[0] = nombrePunto[i];
                                ...
                                }else if(sistemadestinoRef == 'Gauss - Krüger'){
                                  if (origenGauss == true){
                                  List<CoordenadasElipsoidales> listCoorElip = List<CoordenadasElipsoidales>(cont);
                                  List<CoordenadasGauss> listCoorGauss = List<CoordenadasGauss>(cont);
                                  List<String> nombrePunto = List<String>(cont);
                                  List<List<dynamic>> ref2Elispodailes = List<List<dynamic>>(cont+1);
                                  List<String> puntos0 = List(4);
                                  puntos0[0] = 'ID Punto';
                               ...
                               for (var i = 0; i < cont; i++) {
                                  nombrePunto[i] = listaRef[i].Nombre_Punto;
                                  listCoorElip[i] = conversionCoordenadasMB.gauss2Elipsoidales(gaussCS, CoordenadasGauss(norte: listaRef[i].Norte, este: listaRef[i].Este, altura: listaRef[i].Altura));
                                  listCoorGauss[i] = conversionCoordenadasMB.elipsoidales2Gauss(listCoorElip[i], gaussCOrigen);
                                  List<dynamic> puntos = List(4);
                                  puntos[0] = nombrePunto[i];
                                ...
                                //Planas Cartesianas
                                else if(sistemadestinoRef == 'Planas Cartesianas'){
                                  if (origenCartesiano == true){
                                  List<CoordenadasElipsoidales> listCoorElip = List<CoordenadasElipsoidales>(cont);
                                  List<CoordenadasCartesianas> listCoorCartesian = List<CoordenadasCartesianas>(cont);
                                  List<String> nombrePunto = List<String>(cont);
                                  List<List<dynamic>> ref2Elispodailes = List<List<dynamic>>(cont+1);
                                  List<String> puntos0 = List(4);
                                  puntos0[0] = 'ID Punto';
                               ...
                               for (var i = 0; i < cont; i++) {
                                  nombrePunto[i] = listaRef[i].Nombre_Punto;
                                  listCoorElip[i] = conversionCoordenadasMB.gauss2Elipsoidales(gaussCS, CoordenadasGauss(norte: listaRef[i].Norte, este: listaRef[i].Este, altura: listaRef[i].Altura));
                                  listCoorCartesian[i] = conversionCoordenadasMB.elipsoidales2Cartesianas(origenCartesian, listCoorElip[i]);
                                  List<dynamic> puntos = List(4);
                                  puntos[0] = nombrePunto[i];
