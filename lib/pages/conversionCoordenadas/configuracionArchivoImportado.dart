...
class ConfiguracionArchivoImportado extends StatefulWidget {
  ...
  ConfiguracionArchivoImportado(
      {Key key, this.destinoCS, this.origenCS, this.dataCSV})
      : super(key: key);

  @override
  _ConfiguracionArchivoImportadoState createState() =>
      _ConfiguracionArchivoImportadoState();
}

class _ConfiguracionArchivoImportadoState
    extends State<ConfiguracionArchivoImportado> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.origenCS == 'Elipsoidales') {
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: 10),
                    Text(
                      'Conversión de archivo CSV con coordenadas ${widget.origenCS} a ${widget.destinoCS}',
                          ...
                          child: Column(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Text(
                                  'Seleccione el nombre del Campo que contiene los valores de la Latitud',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                    ...
                    Center(
                      ...
                      onPressed: () async {
                        if (indexIDElip == indexLatitud) {
                          ...
                          List<List<dynamic>> puntosElip2Geocentricas =
                              List<List<dynamic>>(widget.dataCSV.length + 1);
                          ...
                          if (encabezado == true) {
                            for (var i = 1; i < widget.dataCSV.length; i++) {
                              ...
                              CoordenadasGeocentricas coorGeo =
                                  CoordenadasGeocentricas();
                              CoordenadasElipsoidales coorElip =
                              ...
                              try {
                                ...
                                ConversionCoordenadasMB
                                    conversionCoordenadasMB =
                                    ConversionCoordenadasMB();
                                coorGeo = conversionCoordenadasMB
                                    .elipsoidales2Geocentricas(coorElip);
                                puntosGeoce[0] = puntos[indexIDElip];
                                puntosGeoce[1] =
                                    double.parse(coorGeo.x.toString());
                                puntosGeoce[2] =
                                    double.parse(coorGeo.y.toString());
                                puntosGeoce[3] =
                                    double.parse(coorGeo.z.toString());
                          ...
                          if (validacion == true) {
                            ...
                            final File csvGuardar = File(
                                '${directorio.path}/MeasureBookConversiónGeocentricas.csv');
                            String datosCSV = const ListToCsvConverter()
                                .convert(puntosElip2Geocentricas);
                            ...
                            await Share.file(
                                ...
                                'MeasureBookConversiónGeocentricas.csv',
                                arCSv,
                                'file/csv',
                                text: 'Conversión de Coordenadas MeasureBook');
                          }
                        }
                      },
                      child: Column(children: [
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            'Exportar Coordenadas Convertidas a CSV',
                            textAlign: TextAlign.center,
                    ...
                    Container(
                        child: origenGauss
                            ? Container(
                                ...
                                title: Text('Origen de Cordenadas Destino',
                                    style: TextStyle(
                                      fontFamily: 'Roboto',
                                      fontSize: 13.0,
                                      color: Color(0xff007FFF),
                                    )),
                                subtitle: Text('${gaussCOrigen.NOMBRE}',
                                    style: TextStyle(
                                      fontFamily: 'Roboto',
                                      fontSize: 16.0,
                                      color: Colors.black54,
                            ...
                            : Container(
                                ...
                                title: Text(
                                    'Seleccionar Origen de Coordenadas del Punto',
                                    style: TextStyle(
                                      fontFamily: 'Roboto',
                                      fontSize: 13.0,
                                      color: Color(0xff007FFF),
                                ...
                                subtitle: Text(
                                    'Selecciona el origen en el que se encuentra el punto ',
                                    style: TextStyle(
                                      fontFamily: 'Roboto',
                                      fontSize: 12.0,
                                      color: Colors.black54,
                      ...
                      onPressed: () async {
                        if (origenGauss == true) {
                          if (indexIDElip == indexLatitud) {
                            ...
                            List<List<dynamic>> puntosElip2Gauss =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Norte';
                              ...
                              for (var i = 1; i < widget.dataCSV.length; i++) {
                                ...
                                try {
                                  ...
                                  ConversionCoordenadasMB
                                      conversionCoordenadasMB =
                                      ConversionCoordenadasMB();
                                  coorGauss = conversionCoordenadasMB
                                      .elipsoidales2Gauss(
                                          coorElip, gaussCOrigen);
                                  puntos[0] = puntos[indexIDElip];
                                  puntos[1] =
                                      double.parse(coorGauss.norte.toString());
                                  puntos[2] =
                                      double.parse(coorGauss.este.toString());
                                  puntos[3] =
                                      double.parse(coorGauss.altura.toString());
                            ...
                            if (validacion == true) {
                              final Directory directorio =
                                  await getApplicationDocumentsDirectory();
                              final File csvGuardar = File(
                                  '${directorio.path}/MeasureBookConversiónGauss.csv');
                              String datosCSV = const ListToCsvConverter()
                                  .convert(puntosElip2Gauss);
                              await csvGuardar.writeAsString(datosCSV);
                              Uint8List arCSv = csvGuardar.readAsBytesSync();
                              await Share.file(
                                  'Conversion Archivos MeasureBookAPP',
                                  'MeasureBookConversiónGauss.csv',
                                  arCSv,
                                  'file/csv',
                                  text:
                        ...
                        child: origenCartesiano
                            ? Container(
                                child: ListTile(
                                  ...
                                  title: Text(
                                      'Plano Cartesiano de Origen Seleccionado',
                                      style: TextStyle(
                                        fontFamily: 'Roboto',
                                        fontSize: 13.0,
                                        color: Color(0xff007FFF),
                                      )),
                                  subtitle: Text('${origenCartesian.NOMBRE}',
                                      style: TextStyle(
                                        fontFamily: 'Roboto',
                                        fontSize: 12.0,
                                        color: Colors.black54,
                      ...
                      onPressed: () async {
                        if (origenCartesiano == true) {
                          if (indexIDElip == indexLatitud) {
                            ...
                            List<List<dynamic>> puntosElip2Cartesian =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Norte';
                            ...
                            if (encabezado == true) {
                              for (var i = 1; i < widget.dataCSV.length; i++) {
                                List<dynamic> puntos = List(4);
                                puntos = datosCSVImport[i];
                                CoordenadasCartesianas coordenadasCartesia =
                                ...
                                try {
                                  ...
                                  ConversionCoordenadasMB
                                      conversionCoordenadasMB =
                                      ConversionCoordenadasMB();
                                  coordenadasCartesia = conversionCoordenadasMB
                                      .elipsoidales2Cartesianas(
                                          origenCartesian, coorElip);
                                  puntos[0] = puntos[indexIDElip];
                                  puntos[1] = double.parse(
                                      coordenadasCartesia.norte.toString());
                                  puntos[2] = double.parse(
                                      coordenadasCartesia.este.toString());
                                  puntos[3] = double.parse(
                                      coordenadasCartesia.altura.toString());
                            ...
                            if (origenCartesiano == true) {
                              final Directory directorio =
                                  await getApplicationDocumentsDirectory();
                              final File csvGuardar = File(
                                  '${directorio.path}/MeasureBookConversiónCartesianas.csv');
                              String datosCSV = const ListToCsvConverter()
                                  .convert(puntosElip2Cartesian);
                              await csvGuardar.writeAsString(datosCSV);
                              Uint8List arCSv = csvGuardar.readAsBytesSync();
                              await Share.file(
                                  'Conversion Archivos MeasureBookAPP',
                                  'MeasureBookConversiónCartesiana.csv',
                                  arCSv,
                                  'file/csv',
                                  text:
                                      'Conversión de Coordenadas MeasureBook');
      ...
      } else if (widget.destinoCS == 'Magna Origen Nacional') {
        return Scaffold(
          body: SafeArea(
              child: SingleChildScrollView(
            child: Center(
                    ...
                    Center(
                      ...
                      onPressed: () async {
                        if (indexIDElip == indexLatitud) {
                          ...
                          List<List<dynamic>> puntoselip2ON =
                              List<List<dynamic>>(widget.dataCSV.length + 1);
                          List<String> puntos0 = List(4);
                          puntos0[0] = 'ID Punto';
                          puntos0[1] = 'Norte';
                          puntos0[2] = 'Este';
                          puntos0[3] = 'Altura';
                          puntoselip2ON[0] = puntos0;
                          List<dynamic> datosCSVImport = List();
                          datosCSVImport = widget.dataCSV;
                          if (encabezado == true) {
                            for (var i = 1; i < widget.dataCSV.length; i++) {
                              List<dynamic> puntos = List(4);
                              List<dynamic> puntosOn = List(4);
                              puntos = datosCSVImport[i];
                              ...
                              try {
                                ...
                                coordenadasOn = conversionCoordenadasMB
                                    .elipsoidales2GaussNuevo(coorElip);
                                puntosOn[0] = puntos[indexIDElip];
                                puntosOn[1] = double.parse(
                                    coordenadasOn.norte.toString());
                                puntosOn[2] =
                                    double.parse(coordenadasOn.este.toString());
                                puntosOn[3] = double.parse(
                                    coordenadasOn.altura.toString());
                                puntoselip2ON[i] = puntosOn;
                              } catch (e) {
                                i = widget.dataCSV.length;
                                alertaErrorArchivo();
                                validacion = false;
                          ...
                          if (validacion == true) {
                            ...
                            final File csvGuardar = File(
                                '${directorio.path}/MeasureBookConversiónGeocentricas.csv');
                            String datosCSV = const ListToCsvConverter()
                                .convert(puntoselip2ON);
                            await csvGuardar.writeAsString(datosCSV);
                            Uint8List arCSv = csvGuardar.readAsBytesSync();
                            //final ByteData archivoCSV = await File('${directorio.path}/MeasureBookConversiónGeocentricas.csv').readAsBytes().then((data) => ByteData.view(data as ByteBuffer));
                            await Share.file(
                                'Conversion Archivos MeasureBookAPP',
                                'MagnaOrigenNacional.csv',
                                arCSv,
                                'file/csv',
                                text: 'Conversión de Coordenadas MeasureBook');
                          }
                            ...
                            child: Column(
                              children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.all(20.0),
                                  child: Text(
                                    'Relacione el nombre del campo con la columna del CSV correspondiente',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Colors.blueAccent, fontSize: 13),
                                  ),
                            ...
                            ? Container(
                                child: origenGauss
                                    ? Container(
                                        ...
                                        title:
                                            Text('Origen de Cordenadas Destino',
                                                style: TextStyle(
                                                  fontFamily: 'Roboto',
                                                  fontSize: 13.0,
                                                  color: Color(0xff007FFF),
                        ...
                        onPressed: () async {
                          if (indexIDGeocen == indexXGeo) {
                            ...
                            if (widget.destinoCS == 'Gauss - Krüger') {
                              if (origenGauss == true) {
                                List<List<dynamic>> geocentricas2Gauss =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                puntos0[1] = 'Norte';
                                puntos0[2] = 'Este';
                                ...
                                if (encabezado == true) {
                                  for (var i = 1;
                                    ...
                                    CoordenadasElipsoidales coorElip =
                                        CoordenadasElipsoidales();
                                    try {
                                      coordenadasGeocentricas.x =
                                          puntos[indexXGeo];
                                      coordenadasGeocentricas.y =
                                          puntos[indexYGeo];
                                      coordenadasGeocentricas.z =
                                          puntos[indexZGeo];
                                      ConversionCoordenadasMB
                                          conversionCoordenadasMB =
                                          ConversionCoordenadasMB();
                                      coorElip = conversionCoordenadasMB
                                          .geocentricas2Elipsoidales(
                                              coordenadasGeocentricas);
                                      coordenadasGauss = conversionCoordenadasMB
                                          .elipsoidales2Gauss(
                                              coorElip, gaussCOrigen);
                                      puntos[0] = puntos[indexIDGeocen];
                                      puntos[1] = double.parse(
                                          coordenadasGauss.norte.toString());
                                      puntos[2] = double.parse(
                                          coordenadasGauss.este.toString());
                                      puntos[3] = double.parse(
                                          coordenadasGauss.altura.toString());
                                ...
                                if (validacion == true) {
                                  ...
                                  String datosCSV = const ListToCsvConverter()
                                      .convert(geocentricas2Gauss);
                                  await csvGuardar.writeAsString(datosCSV);
                                  Uint8List arCSv =
                                      csvGuardar.readAsBytesSync();
                                  await Share.file(
                                      'Conversion Archivos MeasureBookAPP',
                                      'MeasureBookConversiónElipsoidales.csv',
                                      arCSv,
                                      'file/csv',
                                      text:
                                          'Conversión de Coordenadas MeasureBook');
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDGeocen == indexXGeo) {
                            ...
                            List<List<dynamic>> geocentricas2Elipsoidales =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Latitud';
                            ...
                            if (encabezado == true) {
                              for (var i = 1; i < widget.dataCSV.length; i++) {
                                ...
                                try {
                                  ...
                                  puntos[0] = puntos[indexIDGeocen];
                                  puntos[1] =
                                      double.parse(coorElip.latitud.toString());
                                  puntos[2] = double.parse(
                                      coorElip.longitud.toString());
                                  puntos[3] =
                                      double.parse(coorElip.altitud.toString());
                            ...
                            if (validacion == true) {
                              ...
                              final File csvGuardar = File(
                                  '${directorio.path}/MeasureBookConversiónElipsoidales.csv');
                              String datosCSV = const ListToCsvConverter()
                                  .convert(geocentricas2Elipsoidales);
                              await csvGuardar.writeAsString(datosCSV);
                              Uint8List arCSv = csvGuardar.readAsBytesSync();
                              await Share.file(
                                  'Conversion Archivos MeasureBookAPP',
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDGeocen == indexXGeo) {
                            ...
                            // Geocentricas a Elipsoidales
                            List<List<dynamic>> geocentricas2ON =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Norte';
                              ...
                              for (var i = 1; i < widget.dataCSV.length; i++) {
                                ...
                                try {
                                  ...
                                  puntos[1] = double.parse(
                                      coordenadasON.norte.toString());
                                  puntos[2] = double.parse(
                                      coordenadasON.este.toString());
                                  puntos[3] = double.parse(
                                      coordenadasON.altura.toString());
                                  geocentricas2ON[i] = puntos;
                                } catch (e) {
                                  alertaErrorArchivo();
                                  validacion = false;
                                }
                            ...
                            ? Container(
                                child: origenGauss
                                    ? Container(
                                        ...
                                        title: Text(
                                            'Origen de Cordenadas de Partida (Gauss)',
                                            style: TextStyle(
                                              fontFamily: 'Roboto',
                                              fontSize: 13.0,
                                              color: Color(0xff007FFF),
                            ...
                            ? Container(
                                child: origenCartesiano
                                    ? Container(
                                        ...
                                        title: Text(
                                            'Origen de Cordenadas de Destino (Cartesianas)',
                                            style: TextStyle(
                                              fontFamily: 'Roboto',
                                              fontSize: 13.0,
                                              color: Color(0xff007FFF),
                        ...
                        onPressed: () async {
                          if (indexIDGauss == indexNorteGauss) {
                            ...
                            if (widget.destinoCS == 'Planas Cartesianas') {
                              if (origenGauss == true) {
                                if (origenCartesiano == true) {
                                  List<List<dynamic>> gauss2Cartesianas =
                                      List<List<dynamic>>(
                                          widget.dataCSV.length + 1);
                                  List<String> puntos0 = List(4);
                                  puntos0[0] = 'ID Punto';
                                  ...
                                  if (encabezado == true) {
                                    for (var i = 1;
                                      ...
                                      CoordenadasElipsoidales coorElip =
                                          CoordenadasElipsoidales();
                                      try {
                                        coordenadasGauss.este =
                                            puntos[indexEsteGauss];
                                        coordenadasGauss.norte =
                                            puntos[indexNorteGauss];
                                        coordenadasGauss.altura =
                                            puntos[indexAlturaGauss];
                                        ConversionCoordenadasMB
                                            conversionCoordenadasMB =
                                            ConversionCoordenadasMB();
                                        coorElip = conversionCoordenadasMB
                                            .gauss2Elipsoidales(
                                                gaussCOrigen, coordenadasGauss);
                                        coordenadasCartesianas =
                                            conversionCoordenadasMB
                                                .elipsoidales2Cartesianas(
                                                    origenCartesian, coorElip);
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDGauss == indexNorteGauss) {
                            ...
                            if (widget.destinoCS == 'Geocentricas') {
                              if (origenGauss == true) {
                                List<List<dynamic>> gauss2Geocentrica =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                ...
                                if (encabezado == true) {
                                  for (var i = 1;
                                    ...
                                    try {
                                      ...
                                      puntos[0] = puntos[indexIDGauss];
                                      puntos[1] = double.parse(
                                          coordenadasGeocentricas.x.toString());
                                      puntos[2] = double.parse(
                                          coordenadasGeocentricas.y.toString());
                                      puntos[3] = double.parse(
                                          coordenadasGeocentricas.z.toString());
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDGauss == indexNorteGauss) {
                            ...
                            if (widget.destinoCS == 'Elipsoidales') {
                              if (origenGauss == true) {
                                List<List<dynamic>> gauss2Elipsoidales =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                ...
                                if (encabezado == true) {
                                  for (var i = 1;
                                    ...
                                    try {
                                      ...
                                      puntos[0] = puntos[indexIDGauss];
                                      puntos[1] = double.parse(
                                          coorElip.latitud.toString());
                                      puntos[2] = double.parse(
                                          coorElip.longitud.toString());
                                      puntos[3] = double.parse(
                                          coorElip.altitud.toString());
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDGauss == indexNorteGauss) {
                            ...
                            if (widget.destinoCS == 'Magna Origen Nacional') {
                              if (origenGauss == true) {
                                List<List<dynamic>> gauss2ON =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                            ...
                            ? Container(
                                child: origenCartesiano
                                    ...
                                    : Container(
                                        ...
                                        title: Text(
                                            'Origen de Cordenadas de Origen (Cartesianas)',
                                            style: TextStyle(
                                              fontFamily: 'Roboto',
                                              fontSize: 13.0,
                                              color: Color(0xff007FFF),
                            ...
                            ? Container(
                                child: origenGauss
                                    ? Container(
                                        ...
                                        title: Text(
                                            'Origen de Cordenadas de Destino (Gauss)',
                                            style: TextStyle(
                                              fontFamily: 'Roboto',
                                              fontSize: 13.0,
                                              color: Color(0xff007FFF),
                        ...
                        onPressed: () async {
                          if (indexIDCartesian == indexNorteCartesian) {
                            ...
                            if (widget.destinoCS == 'Gauss - Krüger') {
                              if (origenCartesiano == true) {
                                if (origenGauss == true) {
                                  List<List<dynamic>> cartesianas2gauss =
                                      List<List<dynamic>>(
                                          widget.dataCSV.length + 1);
                                  List<String> puntos0 = List(4);
                                  puntos0[0] = 'ID Punto';
                                  ...
                                  if (encabezado == true) {
                                    for (var i = 1;
                                      ...
                                      try {
                                        coordenadasCartesianas.este =
                                            puntos[indexEsteCartesian];
                                        coordenadasCartesianas.norte =
                                            puntos[indexNorteCartesian];
                                        coordenadasCartesianas.altura =
                                            puntos[indexAltCartesian];
                                        ConversionCoordenadasMB
                                            conversionCoordenadasMB =
                                            ConversionCoordenadasMB();
                                        coorElip = conversionCoordenadasMB
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDCartesian == indexNorteCartesian) {
                            ...
                            if (widget.destinoCS == 'Elipsoidales') {
                              if (origenCartesiano == true) {
                                List<List<dynamic>> cartesianas2Elipsoidales =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                ...
                                if (validacion == true) {
                                  ...
                                  final File csvGuardar = File(
                                      '${directorio.path}/MeasureBookConversiónElipsoidales.csv');
                                  String datosCSV = const ListToCsvConverter()
                                      .convert(cartesianas2Elipsoidales);
                                  await csvGuardar.writeAsString(datosCSV);
                                  Uint8List arCSv =
                                      csvGuardar.readAsBytesSync();
                                  await Share.file(
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDCartesian == indexNorteCartesian) {
                            ...
                            if (widget.destinoCS == 'Geocentricas') {
                              if (origenCartesiano == true) {
                                List<List<dynamic>> cartesianas2Geocentricas =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                ...
                                if (validacion == true) {
                                  ...
                                  final File csvGuardar = File(
                                      '${directorio.path}/MeasureBookConversiónElipsoidales.csv');
                                  String datosCSV = const ListToCsvConverter()
                                      .convert(cartesianas2Geocentricas);
                                  await csvGuardar.writeAsString(datosCSV);
                                  Uint8List arCSv =
                                      csvGuardar.readAsBytesSync();
                                  await Share.file(
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDCartesian == indexNorteCartesian) {
                            ...
                            if (widget.destinoCS == 'Magna Origen Nacional') {
                              if (origenCartesiano == true) {
                                List<List<dynamic>> cartesianas2ON =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
    ...
    } else if (widget.origenCS == 'Magna Origen Nacional') {
      if (widget.origenCS == 'Magna Origen Nacional') {
        if (widget.destinoCS == 'Magna Origen Nacional') {
          alertaIgualSystemCoor();
          Navigator.pop(context);
        } else if (widget.destinoCS == 'Gauss - Krüger') {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Center(
                          child: FlatButton(
                        onPressed: () async {
                          if (indexIDON == indexNorteON) {
                            alertaIndexCoor('ID Punto', 'Norte');
                          } else if (indexIDON == indexEsteON) {
                            alertaIndexCoor('ID Punto', 'Este');
                          } else if (indexIDON == indexAlturaON) {
                            alertaIndexCoor('ID Punto', 'Altura');
                          } else if (indexNorteON == indexEsteON) {
                            alertaIndexCoor('Norte', 'Este');
                          } else if (indexNorteON == indexAlturaON) {
                            alertaIndexCoor('Norte', 'Altura');
                          } else if (indexEsteON == indexAlturaON) {
                            alertaIndexCoor('Este', 'Altura');
                          } else {
                            if (widget.destinoCS == 'Gauss - Krüger') {
                              if (origenGauss == true) {
                                List<List<dynamic>> oN2Gauss =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                                ...
                                if (encabezado == true) {
                                  for (var i = 1;
                                    ...
                                    try {
                                      coordenadasON.norte =
                                          puntos[indexNorteON];
                                      coordenadasON.este = puntos[indexEsteON];
                                      coordenadasON.altura =
                                          puntos[indexAlturaON];
                                      ConversionCoordenadasMB
                                          conversionCoordenadasMB =
                                          ConversionCoordenadasMB();
                                      coorElip = conversionCoordenadasMB
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDON == indexNorteON) {
                            ...
                            if (widget.destinoCS == 'Planas Cartesianas') {
                              if (origenCartesiano == true) {
                                List<List<dynamic>> oN2Cartesianas =
                                    List<List<dynamic>>(
                                        widget.dataCSV.length + 1);
                                List<String> puntos0 = List(4);
                                puntos0[0] = 'ID Punto';
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDON == indexNorteON) {
                            ...
                            // Geocentricas a Elipsoidales
                            List<List<dynamic>> oN2Elipsodailes =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Latitud';
                            ...
                            if (encabezado == true) {
                              for (var i = 1; i < widget.dataCSV.length; i++) {
                                ...
                                CoordenadasElipsoidales coorElip =
                                    CoordenadasElipsoidales();
                                try {
                                  coordenadasON.norte = puntos[indexNorteON];
                                  coordenadasON.este = puntos[indexEsteON];
                                  coordenadasON.altura = puntos[indexAlturaON];
                                  ConversionCoordenadasMB
                                      conversionCoordenadasMB =
                                      ConversionCoordenadasMB();
                                  coorElip = conversionCoordenadasMB
                              ...
                              for (var i = 0; i < widget.dataCSV.length; i++) {
                                ...
                                CoordenadasElipsoidales coorElip =
                                    CoordenadasElipsoidales();
                                try {
                                  coordenadasON.este = puntos[indexNorteON];
                                  coordenadasON.norte = puntos[indexEsteON];
                                  coordenadasON.este = puntos[indexAlturaON];
                                  ConversionCoordenadasMB
                                      conversionCoordenadasMB =
                                      ConversionCoordenadasMB();
                                  coorElip = conversionCoordenadasMB
                      ...
                      Center(
                        ...
                        onPressed: () async {
                          if (indexIDON == indexNorteON) {
                            ...
                            List<List<dynamic>> on2Geocentricas =
                                List<List<dynamic>>(widget.dataCSV.length + 1);
                            List<String> puntos0 = List(4);
                            puntos0[0] = 'ID Punto';
                            puntos0[1] = 'Coordenada X';
