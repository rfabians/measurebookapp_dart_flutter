...
class ConversionPuntoIndividual extends StatefulWidget {
  ...
  ConversionPuntoIndividual({Key key, this.origen, this.destino})
      : super(key: key);

  @override
  _ConversionPuntoIndividualState createState() =>
      _ConversionPuntoIndividualState();
}
              ...
              child: Column(
                children: <Widget>[
                  ...
                  RichText(
                    ...
                    TextSpan(
                        text: '${widget.origen} a ${widget.destino}',
                        style: TextStyle(
                          fontFamily: 'Roboto',
                          fontSize: 13.0,
                              ...
                              child: Column(
                                children: <Widget>[
                                                  ...
                                                  validator:
                                                    ...
                                                    if (gradosLatitud == null) {
                                                      ...
                                                      if (gradosLatitud > -5 &&
                                                        ...
                                                        mostrarToast(
                                                            'El valor en grados de la Latitud no se encuentra dentro de Colombia');
                                                      }
                                                    }
                                                  },
                                                ),
                                                  ...
                                                  validator:
                                                    ...
                                                    if (minutosLatitud ==
                                                      ...
                                                      if (minutosLatitud >= 0 &&
                                                        ...
                                                        mostrarToast(
                                                            'Error en el campo Minutos de la Latitud');
                                                      }
                                                    }
                                                  },
                                                ),
                                                    ...
                                                    validator:
                                                      ...
                                                      if (segundosLatitud ==
                                                        ...
                                                        if (segundosLatitud >=
                                                          ...
                                                          mostrarToast(
                                                              'Error en el campo Segundos de la Latitud');
                                                        }
                                                      }
                                                    }),
                                                Text('Segundos',
                                                        ...
                                                        validator: (String
                                                          ...
                                                          if (gradosLongitud ==
                                                            ...
                                                            if (gradosLongitud >
                                                              ...
                                                              mostrarToast(
                                                                  'El valor en grados de la Longitud no se encuentra dentro de Colombia');
                                                            }
                                                          }
                                                        },
                                                      ),
                                                        ...
                                                        validator: (String
                                                          ...
                                                          if (minutosLongitud ==
                                                            ...
                                                            if (minutosLongitud >=
                                                              ...
                                                              mostrarToast(
                                                                  'Error en el campo minutos de la longitud');
                                                            }
                                                          }
                                                        },
                                                      ),
                                                        ...
                                                        validator: (String
                                                          ...
                                                          if (segundoLongitud ==
                                                            ...
                                                            if (segundoLongitud >=
                                                              ...
                                                              mostrarToast(
                                                                  'Error en el campo segundos de la longitud');
                                                            }
                                                          }
                                                        },
                                                      ),
                                  ...
                                  FlatButton(
                                    ...
                                    onPressed: () async {
                                      if (_formKeyElipsoidalHex.currentState
                                          .validate()) {
                                        ...
                                        if (widget.destino == 'Geocentricas') {
                                        ...
                                        } else if (widget.destino ==
                                            'Gauss - Krüger') {
                                          _sistemaGauss(
                                              context, coordenadasElipsoidales);
                                        } else if (widget.destino ==
                                            'Planas Cartesianas') {
                                          _alertDialogoCartesianas(
                                              context, coordenadasElipsoidales);
                                        } else if (widget.destino ==
                                            'Elipsoidales') {
                                          ...
                                          coordenadasON =
                                              conversionCoordenadasMB
                                                  .elipsoidales2GaussNuevo(
                                                      coordenadasElipsoidales);
                                          AlertDialog elipsoidales2On =
                                              AlertDialog(
                                                  shape: RoundedRectangleBorder(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                    ...
                                    child: Text('Convertir a ${widget.destino}',
                                        style: TextStyle(
                                            fontSize: 14.0,
                                            color: Colors.white)),
                                  )
                                ...
                                children: <Widget>[
                                  TextFormField(
                                    ...
                                    validator: (String latitude) {
                                      double latitudPuntoII =
                                          double.tryParse(latitude);
                                      if (latitudPuntoII == null) {
                                        return 'Ingrese la Latitud en formato Decimal';
                                      } else {
                                        if (double.parse(latitude) > -5 &&
                                            double.parse(latitude) < 15) {
                                          double latitudepuntoII =
                                              double.parse(latitude);
                                          latitudepunto = latitudepuntoII;
                                          return null;
                                        } else {
                                          return 'El valor Ingresado esta por fuera de Colombia';
                                        }
                                      }
                                    },
                                  ),
                                  TextFormField(
                                    ...
                                    validator: (String longitud) {
                                      double longitudPuntoII =
                                          double.tryParse(longitud);
                                      if (longitudPuntoII == null) {
                                        return 'Ingrese la Longitud en formato Decimal';
                                      } else {
                                        if (double.parse(longitud) > -82 &&
                                            double.parse(longitud) < -65) {
                                          longitudPuntoII =
                                  ...
                                  FlatButton(
                                      ...
                                      child: Text(
                                          'Convertir a ${widget.destino}',
                                          style: TextStyle(
                                              fontSize: 14.0,
                                              color: Colors.white)),
                                      color: Colors.black54,
                                      onPressed: () {
                                        if (_formKeyElipsoidalDec.currentState
                                            .validate()) {
                                          CoordenadasElipsoidales coorElipdec =
                                              CoordenadasElipsoidales();
                      ...
                      FlatButton(
                        ...
                        onPressed: () {
                          if (_formKeyGeocentricas.currentState.validate()) {
                            CoordenadasGeocentricas coordenadasGeocentricas =
                                CoordenadasGeocentricas();
                            ...
                            CoordenadasElipsoidales coordenadasElipsoidales =
                                CoordenadasElipsoidales();
                            coordenadasElipsoidales = conversionCoordenadasMB
                                .geocentricas2Elipsoidales(
                                    coordenadasGeocentricas);
                            if (widget.destino == 'Elipsoidales') {
                              AlertDialog geocentricas2Elipsoidales =
                                  AlertDialog(
                                      shape: RoundedRectangleBorder(
                                          borderRadius:
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Align(
                                            alignment: Alignment.centerRight,
                                            child: Text(
                                              roundDouble(coordenadasON.este, 3)
                                                  .toString(),
                                              style: TextStyle(
                                                  color: Colors.blueAccent,
                                                  fontSize: 12),
                  ...
                  Container(
                      child: origenGauss
                          ? Container(
                              ...
                              title: Text('Origen de Cordenadas Seleccionado',
                                  style: TextStyle(
                                    fontFamily: 'Roboto',
                                    fontSize: 13.0,
                      ...
                      if (origenGauss == true) {
                        if (_formKeyGauss.currentState.validate()) {
                          ...
                          CoordenadasElipsoidales coordenadasElipsoidales =
                              CoordenadasElipsoidales();
                          coordenadasElipsoidales =
                              conversionCoordenadasMB.gauss2Elipsoidales(
                                  gaussCOrigen, coordenadasGaussForm);
                          if (widget.destino == 'Elipsoidales') {
                            ...
                            CoordenadasGeocentricas coordenadasGeocentricas =
                                CoordenadasGeocentricas();
                            coordenadasGeocentricas = conversionCoordenadasMB
                                .elipsoidales2Geocentricas(
                                    coordenadasElipsoidales);
                            ...
                            CoordenadasON coordenadasON = CoordenadasON();
                            coordenadasON =
                                conversionCoordenadasMB.elipsoidales2GaussNuevo(
                                    coordenadasElipsoidales);
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        ...
                                        Align(
                                          alignment: Alignment.centerRight,
                                          child: Text(
                                            roundDouble(coordenadasON.norte, 3)
                                                .toString(),
                                            style: TextStyle(
                                                color: Colors.blueAccent,
                                                fontSize: 12),
                                        ...
                                        Align(
                                          alignment: Alignment.centerRight,
                                          child: Text(
                                            roundDouble(coordenadasON.altura, 3)
                                                .toString(),
                                            style: TextStyle(
                                                color: Colors.blueAccent,
                                                fontSize: 12),
                        ...
                        if (origenCartesiano == true) {
                          if (_formKeyPlanasCartesianas.currentState
                            ...
                            CoordenadasElipsoidales coordenadasElipsoidales =
                                CoordenadasElipsoidales();
                            coordenadasElipsoidales =
                                conversionCoordenadasMB.cartesianas2Elipoidales(
                                    coordenadasCartesianasForm,
                                    origenCartesian);
                            if (widget.destino == 'Elipsoidales') {
                        ...
                        onPressed: () {
                          if (_formKeyGeocentricas.currentState.validate()) {
                            ...
                            CoordenadasElipsoidales coordenadasElipsoidales =
                                CoordenadasElipsoidales();
                            coordenadasElipsoidales = conversionCoordenadasMB
                                .origenNacional2Elipsoidales(coordenadasOn);
                            if (widget.destino == 'Elipsoidales') {
                                  ...
                                  content: Container(
                                    ...
                                    child: Center(
                                      child: Column(
                                        children: <Widget>[
                                          Text(
                                              'Coordenadas Geocentricas (WGS 80)',
                                              style: TextStyle(
                                                  color: Colors.blueAccent,
                                                  fontSize: 13)),
                                          Divider(),
...
// Obtener listado de departamentos para filtrar planos cartesianos por Municipio
  void _alertDialogoCartesianas(
      BuildContext context, CoordenadasElipsoidales elipCoor) {
    showDialog(
        context: context,
...
//Obtener Planos Cartesianos por municipio seleccionado
  void _alertDialogoCartesianasMunicipio(BuildContext context,
      int fk_Departamento, CoordenadasElipsoidales elipCoor) {
    showDialog(
        context: context,
        builder: (context) => Container(
              height: 500,
...
// Obtener Datos Origen Coordenadas Planas Cartesianas
  ...
  void _conversionGauss(BuildContext context, GaussCS gaussCS,
      CoordenadasElipsoidales coordenadasElp) {
    ...
    coordenadasGauss =
        conversionCoordenadasMB.elipsoidales2Gauss(coordenadasElp, gaussCS);
    AlertDialog elipsoidales2Gauss = AlertDialog(
        ...
        content: Container(
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                Text('Coordenadas Gauss Krüger origen ${gaussCS.NOMBRE}',
                    style: TextStyle(color: Colors.blueAccent, fontSize: 13)),
                Divider(),
                Align(
                  alignment: Alignment.centerRight,
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasGauss.norte, 3).toString(),
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasGauss.este, 3).toString(),
                    style: TextStyle(color: Colors.blueAccent, fontSize: 12),
                  ),
                ),
                Divider(),
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasGauss.altura, 3).toString(),
                    style: TextStyle(color: Colors.blueAccent, fontSize: 12),
                  ),
                ),
                Divider(height: 10),
  ...
  void _conversionPlanasCartesianas(BuildContext context,
      CartesianasCS cartesianasCS, CoordenadasElipsoidales elipCoor) {
    ConversionCoordenadasMB conversionCoordenadasMB = ConversionCoordenadasMB();
    CoordenadasCartesianas coordenadasCartesianas = CoordenadasCartesianas();
    coordenadasCartesianas = conversionCoordenadasMB.elipsoidales2Cartesianas(
        cartesianasCS, elipCoor);
            ...
            child: Column(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasCartesianas.norte, 3).toString(),
                    style: TextStyle(color: Colors.blueAccent, fontSize: 12),
                  ),
                ),
                Divider(),
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasCartesianas.este, 3).toString(),
                    style: TextStyle(color: Colors.blueAccent, fontSize: 12),
                  ),
                ),
                Divider(),
                ...
                Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    roundDouble(coordenadasCartesianas.altura, 3).toString(),
                    style: TextStyle(color: Colors.blueAccent, fontSize: 12),
                  ),
                ),
                Divider(height: 10),
  ...
  void mostrarToast(String mensajeUser) {
