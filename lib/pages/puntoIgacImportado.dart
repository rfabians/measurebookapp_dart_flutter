...
class _PuntoIgacImportadoState extends State<PuntoIgacImportado> {
  ...
  void initState() {
    super.initState();
    _textEditingAlturaController
        .addListener(_textEditingAlturaControllerListener);
  }

  void _textEditingAlturaControllerListener() {
    if (alturaOrtometrica == true) {
      _textEditingAlturaController.text =
          (widget.altura - widget.ondulacion).toString();
    } else {
                ...
                child: Center(
                  child: Column(
                    children: <Widget>[
                      ...
                      TextFormField(
                        initialValue:
                            '${roundDouble(widget.altura - widget.ondulacion, 3)}',
                        decoration: InputDecoration(
                          icon: Icon(Icons.add_location),
